    ...
    (set, get) => ({
      ...
      addBook: async (book) => {
        try {
          ...
          set((state) => ({ books: [{ ...book, id }, ...state.books] }));
        } catch (error) {
      ...
      addSuggestion: async (suggestion) => {
        try {
          ...
          set((state) => ({ suggestions: [{ ...suggestion, id }, ...state.suggestions] }));
        } catch (error) {
      ...
      addPoll: async (poll) => {
        try {
          ...
          set((state) => ({
            polls: [{ id, question: poll.question, options, totalVotes: 0 }, ...state.polls],
          }));
        } catch (error) {
      ...
      addInterview: async (interview) => {
        try {
          ...
          set((state) => ({ interviews: [{ ...interview, id, dialogues }, ...state.interviews] }));
        } catch (error) {
